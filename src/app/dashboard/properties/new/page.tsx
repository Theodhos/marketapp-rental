    ...
    return (
        <div className="min-h-screen bg-background px-6 py-16">
            <div className="mx-auto w-full max-w-3xl">
                <h1 className="text-3xl font-bold text-zinc-900 mb-8">Add New Property</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-6 bg-white p-6 rounded-xl border border-zinc-200">
                    ...
                    <div>
                        ...
                        />
                        {formData.mainImage && (
                            <img src={formData.mainImage} alt="Main" className="mt-2 h-32 w-32 object-cover rounded-md" />
                        )}
                    </div>
